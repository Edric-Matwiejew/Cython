...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "matrixMult",
        "sources": [
            "/mnt/c/Users/21469154/linux_dir/Cython/examples/4_slurm/matrixMult.pyx"
        ]
    },
...
#define __PYX_HAVE__matrixMult
#define __PYX_HAVE_API__matrixMult
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <omp.h>
...
/* Module declarations from 'matrixMult' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static int __pyx_v_10matrixMult_iterations;
static int __pyx_v_10matrixMult_i;
static int __pyx_v_10matrixMult_j;
static int __pyx_v_10matrixMult_N;
static double __pyx_v_10matrixMult_A[0x2328][0x2328];
static double __pyx_v_10matrixMult_b[0x2328];
static double __pyx_v_10matrixMult_c[0x2328];
...
static void __pyx_f_10matrixMult_matrixVectorDot(int, __Pyx_memviewslice, double *, double *); /*proto*/
...
#define __Pyx_MODULE_NAME "matrixMult"
extern int __pyx_module_is_main_matrixMult;
int __pyx_module_is_main_matrixMult = 0;

/* Implementation of 'matrixMult' */
...
static void __pyx_f_10matrixMult_matrixVectorDot(int __pyx_v_N, __Pyx_memviewslice __pyx_v_A, double *__pyx_v_v, double *__pyx_v_u) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("matrixMult.matrixVectorDot", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "matrixMult._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_matrixMult(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_matrixMult},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initmatrixMult(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initmatrixMult(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_matrixMult(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_matrixMult(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_matrixMult(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  int __pyx_t_1;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'matrixMult' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_matrixMult(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("matrixMult", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_matrixMult) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "matrixMult")) {
      if (unlikely(PyDict_SetItemString(modules, "matrixMult", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     double A[9000][9000]
 */
  __pyx_v_10matrixMult_iterations = 0x64;
 ...
 */
  {
      ...
      #endif
      /*try:*/ {
        __pyx_t_1 = __pyx_v_10matrixMult_N;
        if ((1 == 0)) abort();
        {
            int __pyx_parallel_temp0 = ((int)0xbad0bad0);
            int __pyx_parallel_temp1 = ((int)0xbad0bad0);
            ...
            if (__pyx_t_3 > 0)
            {
                ...
                #endif /* _OPENMP */
                {
                    ...
                    #endif /* _OPENMP */
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_10matrixMult_i) lastprivate(__pyx_v_10matrixMult_i) lastprivate(__pyx_v_10matrixMult_j)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        if (__pyx_parallel_why < 2)
                        {
                            __pyx_v_10matrixMult_i = (int)(0 + 1 * __pyx_t_2);
                            /* Initialize private variables to invalid values */
                            __pyx_v_10matrixMult_j = ((int)0xbad0bad0);
 ...
 */
                            ...
                            (__pyx_v_10matrixMult_b[__pyx_v_10matrixMult_i]) = (__pyx_t_4 / ((double)RAND_MAX));
 ...
 * 
 */
                            __pyx_t_5 = __pyx_v_10matrixMult_N;
                            __pyx_t_6 = __pyx_t_5;
                            for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
                              __pyx_v_10matrixMult_j = __pyx_t_7;
 ...
 */
                              ((__pyx_v_10matrixMult_A[__pyx_v_10matrixMult_i])[__pyx_v_10matrixMult_j]) = 1.0;
                            }
                            goto __pyx_L12;
                            __pyx_L7_error:;
                            {
                            ...
                            #endif /* _OPENMP */
                            {
                                __pyx_parallel_temp0 = __pyx_v_10matrixMult_i;
                                __pyx_parallel_temp1 = __pyx_v_10matrixMult_j;
                            }
                            __pyx_L12:;
                            #ifdef _OPENMP
                            #pragma omp flush(__pyx_parallel_why)
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              __pyx_v_10matrixMult_i = __pyx_parallel_temp0;
              __pyx_v_10matrixMult_j = __pyx_parallel_temp1;
              switch (__pyx_parallel_why) {
                    case 4:
                {
                    #ifdef WITH_THREAD
 ...
 */
  __pyx_t_3 = __pyx_v_10matrixMult_iterations;
  __pyx_t_2 = __pyx_t_3;
  for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_t_2; __pyx_t_1+=1) {
    __pyx_v_10matrixMult_i = __pyx_t_1;
 ...
 */
    __pyx_t_10 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 31, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_9 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)0x2328), ((Py_ssize_t)0x2328)); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_8 = __pyx_array_new(__pyx_t_9, sizeof(double), PyBytes_AS_STRING(__pyx_t_10), (char *) "c", (char *) __pyx_v_10matrixMult_A);
    if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 31, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(((PyObject *)__pyx_t_8), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 31, __pyx_L1_error)
    __Pyx_DECREF(((PyObject *)__pyx_t_8)); __pyx_t_8 = 0;
    __pyx_f_10matrixMult_matrixVectorDot(__pyx_v_10matrixMult_N, __pyx_t_11, __pyx_v_10matrixMult_b, __pyx_v_10matrixMult_c);
        ...
        /*try:*/ {
          ...
          if ((1 == 0)) abort();
          {
              ...
              if (__pyx_t_7 > 0)
              {
                  ...
                  {
                      #ifdef _OPENMP
                      #pragma omp for firstprivate(__pyx_v_10matrixMult_j) lastprivate(__pyx_v_10matrixMult_j)
                      #endif /* _OPENMP */
                      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                          {
                              __pyx_v_10matrixMult_j = (int)(0 + 1 * __pyx_t_6);
 ...
 *         c[j] = 0             # <<<<<<<<<<<<<<
 */
                              (__pyx_v_10matrixMult_c[__pyx_v_10matrixMult_j]) = 0.0;
                          }
                      }
                  }
              }
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init matrixMult", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init matrixMult");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
